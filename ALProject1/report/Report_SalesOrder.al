report 90008 Report_SalesOrder
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    DefaultLayout = RDLC;
    RDLCLayout = 'Layouts/Report_SalesOrder.rdl';
    ...
    //             group(GroupName)
    //             {
    //                 field(SalesLine; Salesorder_Number)
    //                 {
    //                     ApplicationArea = All;
    //                     Caption = 'SalesOrder_Number';
    //                 }
    //             }
    //         }
    //     }
